...
Base.:(==)(left::ExponentialFamilyDistribution, right::ExponentialFamilyDistribution) =
    ...
    getsufficientstatistics(left) == getsufficientstatistics(right) && Distributions.support(left) == Distributions.support(right)
...
struct KnownExponentialFamilyDistribution{T, P, C}
    naturalparameters::P
    conditioner::C
    KnownExponentialFamilyDistribution(::Type{T}, naturalparameters::P, conditioner::C = nothing) where {T, P, C} = begin
...
Distributions.logpdf(exponentialfamily::KnownExponentialFamilyDistribution, x) = Distributions.logpdf(Base.convert(Distribution, exponentialfamily), x)
Distributions.pdf(exponentialfamily::KnownExponentialFamilyDistribution, x) = Distributions.pdf(Base.convert(Distribution, exponentialfamily), x)
