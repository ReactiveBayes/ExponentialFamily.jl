...
Base.convert(::Type{CategoricalNaturalParameters}, vector::AbstractVector) = convert(CategoricalNaturalParameters{eltype(vector)}, vector)

Base.convert(::Type{CategoricalNaturalParameters{T}}, vector::AbstractVector) where {T} = CategoricalNaturalParameters(convert(AbstractVector{T}, vector))
