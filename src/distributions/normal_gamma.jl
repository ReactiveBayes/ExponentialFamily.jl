...
function fisherinformation(exponentialfamily::KnownExponentialFamilyDistribution{NormalGamma})
    ...
    info_matrix[1, 1] = ((((η1^2) / (4η2) - η4)^-1)*(-0.5 - η3) + (-(η1^2)*(((η1^2) / (4η2) - η4)^-2)*(-0.5 - η3)) / (2η2)) / (2η2)
    info_matrix[2, 1] = (-η1*(((η1^2) / (4η2) - η4)^-1)*(-0.5 - η3)) / (2*(η2^2)) + (2η1*((η1^2) / (16*(η2^2)))*(((η1^2) / (4η2) - η4)^-2)*(-0.5 - η3)) / η2
    info_matrix[3, 1] = (-η1*(((η1^2) / (4η2) - η4)^-1)) / (2η2)
    info_matrix[4, 1] = (η1*(((η1^2) / (4η2) - η4)^-2)*(-0.5 - η3)) / (2η2)
    info_matrix[1, 2] = ((η1^3)*(((η1^2) / (4η2) - η4)^-2)*(-0.5 - η3)) / (8*(η2^3)) + (-η1*(((η1^2) / (4η2) - η4)^-1)*(-0.5 - η3)) / (2*(η2^2))
    info_matrix[2, 2] = (1//2)*(η2^-2) + (-(η1^2)*((η1^2) / (16*(η2^2)))*(((η1^2) / (4η2) - η4)^-2)*(-0.5 - η3)) / (η2^2) + 128η2*((η1^2) / (256*(η2^4)))*(((η1^2) / (4η2) - η4)^-1)*(-0.5 - η3)
